...
app.use("/", require("./routes/users/user.routes")); // / root or Home
app.use("/", require("./routes/categories/category.routes"));
app.use("/", require("./routes/subcategories/subcategory.routes"));
